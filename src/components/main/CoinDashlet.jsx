    ...
    <Modal>
      ...
      <Card>
        ...
        <InlineList align={'flex-start'} spacingBetween={10} verticalAlign={'center'}>
          <Button size={'small'} onPress={() => openModal(TRADE_COIN_MODAL, {type: 'buy', name, price: priceLabel})}>매도</Button>
          <Button size={'small'} onPress={() => openModal(TRADE_COIN_MODAL, {type: 'sell', name, price: priceLabel})}>매수</Button>
        </InlineList>
      </Card>
      )}
    </Modal>
